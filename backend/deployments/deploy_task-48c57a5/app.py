...
Generated: 2026-02-06T08:18:09.369502
...
# Constants
FEATURE_ORDER = ['Order ID', 'Customer ID', 'Item', 'Price', 'Quantity', 'Order Total', 'Order Date', 'Category_Desserts', 'Category_Drinks', 'Category_Main Dishes', 'Category_Side Dishes', 'Category_Starters']
MODEL_TYPE = "classification"
TARGET_CLASSES = ['Cash', 'Credit Card', 'Digital Wallet']
...
class PredictRequest(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "data": {"Order ID": "value", "Customer ID": "value", "Item": "value"}
            }
        }
